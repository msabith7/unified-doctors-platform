    ...
    return (
        <div className="app-container">
            ...
            <div className="main-wrapper">
                <Header title={`Prescriptions – ${patientName}`} />
                <main className="content">
                    <div className="doctor-patient-detail-page">
                        ...
                        <div className="doctor-patient-detail-card">
                            <Pill size={32} className="doctor-patient-detail-icon" />
                            <h2>Prescriptions for {patientName}</h2>
                            <p className="doctor-patient-detail-message">
                                Prescription history and current medications for this patient will appear here.
                            </p>
                        </div>
                    </div>
                </main>
